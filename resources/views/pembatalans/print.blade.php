        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th class="text-center align-middle">Alasan Pembatalan</th>
                </tr>
            </thead>
            <tbody>
                <?php $no = 1; ?>
                <?php foreach ($pembatalan as $data) : ?>
                <tr>
                    ...
                    <td class="text-center align-middle"><?php echo $data->tanggal_pembatalan; ?></td>
                    <td class="text-center align-middle"><?php echo $data->alasan_pembatalan; ?></td>
                </tr>
