        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th class="text-center align-middle">Tanggal Perubahan</th>
                    <th class="text-center align-middle">Disetujui Oleh</th>
                    <th class="text-center align-middle">Alasan Perubahan</th>
                </tr>
            </thead>
            <tbody>
                <?php $no = 1; ?>
                <?php foreach ($perubahanjadwal as $data) : ?>
                <tr>
                    <td class="text-center align-middle"><?php echo $no; ?></td>
                    <td class="text-center align-middle"><?php echo $data->peminjaman->ruangan->nama_ruangan; ?></td>
                    <td class="text-center align-middle"><?php echo $data->peminjaman->petugas->name; ?></td>
                    ...
                    <td class="text-center align-middle"><?php echo $data->tanggal_perubahan; ?></td>
                    <td class="text-center align-middle"><?php echo $data->petugas->name; ?></td>
                    <td class="text-center align-middle"><?php echo $data->alasan_perubahan; ?></td>
                </tr>
