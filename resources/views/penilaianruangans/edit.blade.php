<x-app-layout>
    ...
    <div class="p-4 bg-white rounded-lg shadow-xs">
        <form action="{{ route('penilaianruangans.update', $penilaianruangan->id) }}" method="POST"
            ...
            <div class="grid grid-cols-2 gap-6 mt-4">
                    ...
                    <select name="id_ruangan" id="id_ruangan"
                        ...
                        @foreach ($ruangans as $ruangan)
                            <option value="{{ $ruangan->id }}"
                                {{ $penilaianruangan->id_ruangan == $ruangan->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="kebersihan" id="kebersihan"
                        class="block w-full px-3 py-2 mt-1 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        <option value="bersih" {{ $penilaianruangan->kebersihan == 'bersih' ? 'selected' : '' }}>Bersih
                        </option>
                        <option value="cukup bersih"
                            {{ $penilaianruangan->kebersihan == 'cukup bersih' ? 'selected' : '' }}>Cukup Bersih
                        </option>
                        <option value="kurang bersih"
                            {{ $penilaianruangan->kebersihan == 'kurang bersih' ? 'selected' : '' }}>Kurang Bersih
                        </option>
                    </select>
                    @error('kebersihan')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
            ...
            <div class="grid grid-cols-2 gap-6 mt-4">
                ...
                <div>
                    ...
                    <select name="kenyamanan" id="kenyamanan"
                        class="block w-full px-3 py-2 mt-1 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        <option value="nyaman" {{ $penilaianruangan->kenyamanan == 'nyaman' ? 'selected' : '' }}>Nyaman
                        </option>
                        <option value="cukup nyaman"
                            {{ $penilaianruangan->kenyamanan == 'cukup nyaman' ? 'selected' : '' }}>Cukup Nyaman
                        </option>
                        <option value="kurang nyaman"
                            {{ $penilaianruangan->kenyamanan == 'kurang nyaman' ? 'selected' : '' }}>Kurang Nyaman
                        </option>
                    </select>
                    @error('kenyamanan')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                ...
                <div>
                    ...
                    <select name="kelengkapan_fasilitas" id="kelengkapan_fasilitas"
                        ...
                        <option value="lengkap"
                            {{ $penilaianruangan->kelengkapan_fasilitas == 'lengkap' ? 'selected' : '' }}>Lengkap
                        </option>
                        <option value="cukup lengkap"
                            {{ $penilaianruangan->kelengkapan_fasilitas == 'cukup lengkap' ? 'selected' : '' }}>Cukup
                            Lengkap</option>
                        <option value="kurang lengkap"
                            {{ $penilaianruangan->kelengkapan_fasilitas == 'kurang lengkap' ? 'selected' : '' }}>Kurang
                            Lengkap</option>
                    </select>
