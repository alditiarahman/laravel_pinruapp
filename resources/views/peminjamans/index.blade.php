                                ...
                                <td class="px-4 py-3 text-sm">
                                    <div class="flex space-x-2 items-center">
                                        ...
                                        <a href="{{ route('peminjamans.edit', $pinjam->id) }}"
                                            ...
                                            x-show="('{{ auth()->user()->hasRole('peminjam') }}' && '{{ $pinjam->status }}' === 'menunggu' || '{{ $pinjam->status }}' === 'ditolak')">
                                            Edit
                                        </a>
                                            ...
                                            <div x-show="openDelete"
                                                ...
                                                <div x-show="openDelete"
                                                    ...
                                                    <footer
                                                        ...
                                                        <form action="{{ route('peminjamans.destroy', $pinjam->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
                                            ...
                                            <div x-show="openVerify"
                                                ...
                                                <div x-show="openVerify"
                                                    ...
                                                    <footer
                                                        ...
                                                        <form action="{{ route('peminjamans.verify', $pinjam->id) }}"
                                            ...
                                            <div x-show="openReject"
                                                ...
                                                <div x-show="openReject"
                                                    ...
                                                    <div class="mt-4 mb-6">
                                                        ...
                                                        <form action="{{ route('peminjamans.reject', $pinjam->id) }}"
